...
public class Game {
    ...
    // player2 is declared as Player to support both HumanPlayer and CpuPlayer via polymorphism
    private Player player2;
    // the player whose turn it currently is
    private Player currentPlayer;
    // the player who first completed a 7x7 area on their quiltboard, null if no one has yet
